...
from moseq2_app.gui.progress import (
    generate_missing_metadata,
    get_session_paths,
    update_progress,
    restore_progress_vars,
    get_pca_progress,
    load_progress,
...
class TestNotebookProgress(TestCase):
    ...
    def test_get_pca_progress(self):
        i_dict = {"pca_dirname": "", "scores_path": "", "changeoints_path": ""}
