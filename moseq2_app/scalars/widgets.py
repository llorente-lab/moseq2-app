...
class InteractiveScalarWidgets:
    ...
    def __init__(self):
        ...
        self.label_layout = widgets.Layout(
            display="flex-grow", flex_flow="column", align_items="center", width="100%"
        )
        ...
        # scalar widgets
        self.checked_list = widgets.SelectMultiple(
            options=[],
            description="Scalar Columns to Plot",
            style=style,
        ...
        self.ui_tools = VBox(
            [self.clear_button, self.checked_list], layout=self.box_layout
        )
